...
const DATA_KEYS = [
  ...
  'shipments', 'viajes', 'tariffs', 'tasks', 'waTemplates', 'costosPresets',
...
const MERGE_BY_ID = new Set(['budgets', 'clients', 'suppliers', 'products', 'insumos', 'stockMoves', 'shipments', 'viajes', 'tariffs', 'tasks', 'waTemplates', 'costosPresets'])

...
// /presupuesto y /presupuesto/:id redirigen a /pedido y /pedido/:id.
// El wizard viejo se removió en Fase 3 del rediseño; el adaptador de
// lib/pedido reconstruye pedidos legacy en la vista nueva.
